...
def override_consumer_auth() -> MagicMock:
    ...
    Returns:
        MagicMock: A mocked user session object with user_id and role.
    """
...
def test_get_my_reservations(mock_querier: MagicMock, client: TestClient) -> None:
    ...
    mock_res = MagicMock(reservation_id=TEST_RESERVATION_ID, bundle_id=TEST_BUNDLE_ID)
...
def test_update_consumer_fail(mock_querier: MagicMock, client: TestClient) -> None:
    ...
    mock_querier.return_value.update_consumer.return_value = None
